...
export const GET_RESTAURNT_BY_USER_ID_REQUEST = "GET_RESTAURNT_BY_USER_ID_REQUEST";

export const GET_RESTAURNT_BY_USER_ID_SUCCESS = "GET_RESTAURNT_BY_USER_ID_SUCCESS";

export const GET_RESTAURNT_BY_USER_ID_FAILURE = "GET_RESTAURNT_BY_USER_ID_FAILURE";
